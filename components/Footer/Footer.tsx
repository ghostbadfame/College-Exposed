...
const Footer: React.FC = () => (
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
        A Comprehensive Rating and Review System for College Experiences.
        </p>
      </div>
      <div className="">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="/" className="text-whit hover:text-blue-400">Home</a>
        </p>
        <p className="mb-4">
          <a href="/#colleges" className="text-white hover:text-blue-400">Colleges</a>
        </p>
        <p className="mb-4">
          <a href="/about" className="text-white hover:text-blue-400">AboutUs</a>
        </p>
        <p className="mb-4">
          <a href="/contact" className="text-white hover:text-blue-400">ContactUs</a>
        </p>
      ...
      <div className="">
        ...
        <p className="flex items-center justify-center md:justify-start mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
            className="hidden md:block w-4 md:mr-4" role="img" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512">
            <path fill="currentColor"
  ...
  <div className="text-start p-6  border-white">
    ...
    <a className="text-white font-semibold" href="https://tailwind-elements.com/"> CollegesExposed Pvt. Ltd. All Rights Reserved.</a>
  </div>
</footer>
