...
const Navbar: React.FC<Props> = ({userName},props: Props) => {
  ...
  return (
    ...
    <div
      ...
      className='fixed left-0 top-0 w-full z-10 ease-in duration-300 z-30 bg-gray-800 '
    >
      <div className='max-w-[1240px] m-auto flex  justify-between items-center p-2 text-white capitalize'>
        ...
        <ul style={{ color: `${textColor}` }} className='hidden sm:flex'>
          ...
          <li className='p-4 hover:underline'>
            <Link className= "flex justify-between" href='/login'><FaUserAlt className="mr-2 mt-1 capitalize"/>{userName}</Link>
          </li>
