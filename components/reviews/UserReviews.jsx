...
const UserReviews = (props) => {
  ...
  const handleDelete = async(review) => {
    try{
      ...
      const totalRating = total - review.rating;

      const response = await axios.delete("/api/reviews?db=" + dbName + "&collection=" + collectionName+"&id=" + review._id) 
  ...
  return (
    ...
    <div className=" container lg:w-2/3  mx-auto mt-10 md:mt-20 flex flex-col items-center justify-center ">
      
      
      <div className="total-review-section  overflow-hidden mx-auto mb-10 md:mb-20">
        
        <div className="left flex mx-auto ">
          <h1 className="font-semibold text-lg text-2xl lg:text-4xl text-gray-700 ">Reviews</h1>
        </div>
        ...
        <div className="flex flex-col items-center justify-evenly  md:flex-row lg:space-x-10 ">
          ...
          <div className="1 my-6 border-2 shadow-xl rounded p-4 justify-center items-center w-56  ">
            ...
            <h1 className="text-gray-500">growth in reviews this year</h1>
          </div>
          ...
          <div className="1 my-6 border-2 shadow-xl rounded p-4 justify-center items-center  w-56 ">
            ...
            <h1 className="text-gray-500">Average Rating in this year</h1>
          </div>
    ...
    <div className="usersReviews mt-10 p-2">
      {
        reviews.length > 0 ? reviews.map((review) => (
          ...
          <div className=" main mx-auto flex flex-col md:flex-row md:space-x-16 lg:space-x-40">

            <div className="left flex items-start md:w-[30%]  mb-6 md:mb-0">
                <div className="profile flex flex-row  space-x-3">

                  
                    <Image src={'https://res.cloudinary.com/dqarxwjx4/image/upload/v1681465689/profile_gxxn6q.webp'}  alt="no-image" className="" height={5} width={60} /> 
                    

                    <span className="flex flex-col ">
                      <h1 className="font-semibold text-xl">{review.userName}</h1>
                      <h1 className=" text-base hidden md:block  text-gray-600">Student</h1>
            ...
            <div className="right  md:w-[60%] flex flex-col justify-evenly ">
              ...
              <div className="comment md:text-lg">
                <h1> 
                  {review.comment}
                </h1>
              </div>
...
{/* flex flex-col md:flex-row p-2 space-y-4 md:space-y-0 mx-auto    md:space-x-4 max-w-max */}
              ...
              <div className="flex border-2 p-2 my-2 max-w-max border-gray-300 rounded-md">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 6h.008v.008H6V6z" />
</svg>

                <h1 className="ml-2">Public comment</h1>
